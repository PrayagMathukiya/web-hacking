...
if "http://" not in site:
    site ="http://"+site
admin = ['/admin/login.php/','/root/','/admin/','/administrator/','/admin1/','/cms/','/admin2/','/admin3/','/admin4/','/admin5/','/usuarios/','/usuario/','/administrator/','/moderator/','/webadmin/','/adminarea/','/bb-admin/','/adminLogin/','/admin_area/','/panel-administracion/','/instadmin/',
...
for i in admin:
    try:
        ...
        if checkurl ==200:
            print site+i,(colored(" ""    [+] Found [+]",'green'))
            continue
    except urllib2.URLError, checkurl:
        if checkurl == 404:
            print site+i,(colored(" ""    Not Found :/",'red'))
        else:
            print site+i,(colored(" ""    Error",'red'))
